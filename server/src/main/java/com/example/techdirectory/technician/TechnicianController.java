...
public class TechnicianController {
    ...
    public ContactResponse contactTechnician(
        ...
        if (technician.getAllowDirectCalls() && request.getContactMethod().equals("call")) {
            response.setPhoneNumber(technician.getPhone());
            response.setAllowed(true);
        } else if (technician.getAllowWhatsApp() && request.getContactMethod().equals("whatsapp")) {
            ...
            response.setAllowed(true);
        } else if (technician.getAllowInAppMessages() && request.getContactMethod().equals("message")) {
